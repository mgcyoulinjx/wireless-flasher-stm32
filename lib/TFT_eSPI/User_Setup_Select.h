...
#include <User_Setups/Setup204_GC9307_240x284.h>    // 1.83  1.83 寸屏使用

// #include <User_Setups/Setup204_GC9307_240x296.h> // 2.01 2.01 寸屏使用
...
#elif defined (GC9307_DRIVER)  // 复用 ST7789 驱动即可
     #include "TFT_Drivers/ST7789_Defines.h"
     #define TFT_DRIVER 0x7789
